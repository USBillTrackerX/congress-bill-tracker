...
def fetch_upcoming_markups(days_ahead: int = 14) -> list:
    ...
    for chamber in ['house', 'senate']:
        # Fetch meeting list (500 to ensure we get upcoming meetings)
        meetings_list = fetch_committee_meeting_list(chamber, limit=500)
...
def find_scheduled_event_for_bill(bill_type: str, bill_number: int) -> Optional[dict]:
    ...
    # Create formatted version for matching in titles
